  ...
  return (
    <div>
      <PageHeader
        ...
        actions={<Button icon={Plus} onClick={() => setFormOpen(true)}>Add Book</Button>}
      />
      ...
      <div className="bg-white rounded-[var(--radius-card)] border border-[var(--color-border-gray)]">
        <DataTable
          ...
          emptyState={
            <EmptyState title="No books found" message="Try a different search, or add a new book to the catalogue." actionLabel="Add Book" onAction={() => setFormOpen(true)} />
          }
        />
      </div>
