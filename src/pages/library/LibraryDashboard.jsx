      ...
      <PageHeader
        ...
        actions={
          <QuickActions actions={[
            { label: t('addBook'), to: '/library/books', icon: BookOpen },
            { label: t('borrowBook'), to: '/library/borrowed', icon: BookMarked },
            { label: t('processReturn'), to: '/library/returns', icon: CheckCircle2 },
          ]} />
        }
      />
