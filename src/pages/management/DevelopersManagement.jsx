                ...
                <article key={index} className="relative rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(12,34,30,0.96),rgba(8,22,20,0.96))] p-4 shadow-[0_16px_32px_rgba(0,0,0,0.18)] md:p-5">
                  ...
                  <div className="grid gap-5 lg:grid-cols-[220px_minmax(0,1fr)]">
                    ...
                    <div className="space-y-4">
                      <Input label={`Developer ${index + 1} name`} required value={developer.name} onChange={(e) => updateDeveloper(index, { name: e.target.value })} className="h-12 text-base" dark />
                      <Input label="Role" required value={developer.role} onChange={(e) => updateDeveloper(index, { role: e.target.value })} className="h-12 text-base" dark />
