...
import { TrendingUp, TrendingDown, AlertTriangle, BookOpen, Bell, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <Button variant="secondary" size="sm" icon={ArrowLeft} onClick={() => navigate('/management')}>
            {t('back') || 'Back'}
          </Button>
        }
      />
