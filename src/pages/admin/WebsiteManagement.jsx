        ...
        <div>
          <form onSubmit={saveContactPage} className="p-6 space-y-4 border-b border-[var(--border)] max-w-3xl">
            ...
            <div className="space-y-4 rounded-xl border border-[var(--color-gold)]/40 bg-[var(--color-soft-gray)] p-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Input label="Developer name" value={contactPageForm.developerName || ''} onChange={(e) => editContactPage((page) => ({ ...page, developerName: e.target.value }))} />
              </div>
            </div>
          ...
          <Input label={t('phone')} required value={contactForm.phone} onChange={(e) => editContact((c) => ({ ...c, phone: e.target.value }))} />
          <Input label={t('email')} required type="email" value={contactForm.email} onChange={(e) => editContact((c) => ({ ...c, email: e.target.value }))} />
