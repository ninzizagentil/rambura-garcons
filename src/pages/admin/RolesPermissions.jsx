...
const PERMISSION_LABELS = {
  ...
  assign: 'permissionAssign', maintenance: 'maintenance', manage: 'permissionManage',
};
...
export default function RolesPermissions() {
  ...
  const handleSave = async () => {
    ...
    if (result.role?.name === currentRole) {
      updatePermissions((result.role.permissions || []).map((permission) => permission.key || permission));
    } else {
