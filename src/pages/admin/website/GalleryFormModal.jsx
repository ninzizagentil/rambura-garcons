...
export default function GalleryFormModal({ open, onClose, image, onSaved }) {
  ...
  // Reset the form when the modal opens (or the edited image changes while
  // open). Done during render instead of in an effect — see
  // https://react.dev/learn/you-might-not-need-an-effect
  const [resetKey, setResetKey] = useState(null);
  const nextResetKey = open ? (image?.id ?? image?._id ?? 'new') : null;
