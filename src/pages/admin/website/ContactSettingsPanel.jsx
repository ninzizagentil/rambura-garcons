...
export default function ContactSettingsPanel() {
  ...
  const handleSave = async () => {
    const problem = Object.values(applyKindErrors({}, form, { phone: 'phone', email: 'email' }, t))[0];
  ...
  return (
    <div className="p-6 space-y-4 max-w-xl">
      ...
      <Input kind="phone" label={t('phone')} value={form.phone} onChange={update('phone')} />
      <Input kind="email" label={t('email')} type="email" value={form.email} onChange={update('email')} />
      <Input
