/**
 * socialGlyphs — the raw SVG icon components for each social platform,
 * split out of socialIcons.js so that file can stay a pure data module
 * (Fast Refresh works best when a file exports either only components,
 * like this one, or only non-component values, like socialIcons.js).
 */
