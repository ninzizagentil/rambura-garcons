import {
  ...
  ClipboardEdit, Truck, GraduationCap, MessageSquare, Code2,
} from 'lucide-react';
...
export const NAV_BY_ROLE = {
  ...
  [ROLES.STOCK_MANAGER]: [
    { label: 'Dashboard', to: '/stock', icon: LayoutDashboard, permission: 'stock.view' },
    {
      ...
      icon: Boxes,
      children: [
        { label: 'All Items', to: '/stock/items', icon: Boxes, permission: 'stock.view' },
        { label: 'Low Stock', to: '/stock/low-stock', icon: TrendingDown, permission: 'stock.view' },
        { label: 'Out of Stock', to: '/stock/out-of-stock', icon: PackageX, permission: 'stock.view' },
        { label: 'Damaged Items', to: '/stock/damaged', icon: ShieldAlert, permission: 'stock.view' },
        { label: 'Expired Items', to: '/stock/expired', icon: CalendarClock, permission: 'stock.view' },
        { label: 'Removed / Disposed', to: '/stock/removed', icon: Archive, permission: 'stock.view' },
      ],
    },
    {
      ...
      icon: PackagePlus,
      children: [
        { label: 'Stock In', to: '/stock/stock-in', icon: PackagePlus, permission: 'stock.in' },
        { label: 'Stock Out', to: '/stock/stock-out', icon: PackageMinus, permission: 'stock.out' },
        { label: 'Stock Adjustment', to: '/stock/adjustment', icon: ClipboardEdit, permission: 'stock.adjust' },
        { label: 'Stock Transfer', to: '/stock/transfer', icon: ArrowLeftRight, permission: 'stock.transfer' },
      ],
    },
    { label: 'Transactions', to: '/stock/transactions', icon: ArrowLeftRight, permission: 'stock.view' },
    { label: 'Suppliers', to: '/stock/suppliers', icon: Truck, permission: 'stock.suppliers' },
    { label: 'Usage Analytics', to: '/stock/analytics', icon: LineChart, permission: 'stock.reports' },
