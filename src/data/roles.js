  ...
  [ROLES.ADMIN]: [
    ...
    { label: 'Library MIS', to: '/library', icon: BookOpen },
    {
      ...
      children: [
        ...
        { label: 'Items',         to: '/stock/items',        icon: Boxes           },
        { label: 'Alerts',        to: '/stock/alerts',       icon: AlertTriangle   },
        { label: 'Receive Stock', to: '/stock/stock-in',     icon: PackagePlus     },
        { label: 'Issue Stock',   to: '/stock/stock-out',    icon: PackageMinus    },
        { label: 'Transfer',      to: '/stock/transfer',     icon: ArrowLeftRight  },
        { label: 'Adjust',        to: '/stock/adjustment',   icon: ClipboardEdit   },
        { label: 'Suppliers',     to: '/stock/suppliers',    icon: Truck           },
        { label: 'Transactions',  to: '/stock/transactions', icon: Activity        },
        { label: 'Damage & Disposal', to: '/stock/activity', icon: ShieldAlert    },
        { label: 'Reports',       to: '/stock/reports',      icon: FileBarChart    },
      ],
    },
