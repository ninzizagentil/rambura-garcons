...
const authLimiter = rateLimit({ windowMs: 15 * 60 * 1000, limit: 10, standardHeaders: 'draft-8', message: { success: false, message: 'Too many authentication attempts. Try again later.' } });
...
router.post('/login/2fa', asyncHandler(verifyLoginTwoFactor));
