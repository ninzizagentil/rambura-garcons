...
export async function createUser(req, res) {
  ...
  return ok(res, user.toObject({ transform: (_doc, ret) => { delete ret.passwordHash; delete ret.refreshTokens; return ret; } }), 'User created', 201);
}
...
export async function setStatus(req, res) {
  ...
  return ok(res, target.toObject({ transform: (_doc, ret) => { delete ret.passwordHash; delete ret.refreshTokens; return ret; } }), 'User status updated');
}
